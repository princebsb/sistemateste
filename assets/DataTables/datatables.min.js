...
(function(f) {
    ...
    function Fa(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && d && "Nenhum registro foi encontrado" === b.sEmptyTable && M(a, a, "sZeroRecords", "sEmptyTable");
    ...
    function tb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            h = a.aanFeatures,
            g = '<input type="Procurar" class="' + b.sFilterInput + '"/>',
            k = d.sSearch;
    ...
    function Wa(a, b, c) {
        ...
        0 === h || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > h && (d = 0)) :
            "first" == b ? d = 0 : "Anterior" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "Próximo" == b ? d + e < h && (d += e) : "last" == b ? d = Math.floor((h - 1) / e) * e : O(a, 0, "Unknown paging action: " + b, 5);
    ...
    z("rows().cache()", "row().cache()", function(a) {
        return this.iterator("row", function(b, c) {
            b = b.aoData[c];
            return "Procurar" === a ? b._aFilterData :
                b._aSortData
        }, 1)
    });
    ...
    z("columns().cache()", "column().cache()", function(a) {
        return this.iterator("column-rows", function(b, c, d, e, f) {
            return ka(b.aoData, f, "Procurar" === a ? "_aFilterData" : "_aSortData", c)
        }, 1)
    });
    z("columns().nodes()",
        "column().nodes()",
    ...
    z("cells().cache()", "cell().cache()", function(a) {
        a = "Procurar" === a ? "_aFilterData" : "_aSortData";
    ...
    f.extend(Ob, {
        ...
        simple_numbers: function(a, b) {
            return ["Anterior", ja(a, b), "Próximo"]
        },
        full_numbers: function(a, b) {
            return ["first", "Anterior", ja(a, b), "Próximo", "last"]
        },
